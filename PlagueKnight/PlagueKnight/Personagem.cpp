...
namespace Personagens {
    ...
    Personagem::Personagem(float x_inicial, float y_inicial, const char* caminho_textura, float largura, float comprimento, int num_v) :
        Entidade(x_inicial, y_inicial, caminho_textura, largura, comprimento) {
        num_vidas = num_v;
    }
